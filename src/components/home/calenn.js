...
const ShowGroupEvents = ({ show, events, toggle, visible }) => {
  ...
  const Calendar = () => {
    ...
    const [events, setEvents] = React.useState([
    {
      ...
      endDate: "2022-05-02T12:00:11.771Z",
      startDate: "2022-05-01T12:00:11.771Z" },
  
    {
      ...
      endDate: "2022-05-14T12:00:11.771Z",
      startDate: "2022-05-10T12:00:11.771Z" },
  
    {
      ...
      endDate: "2022-05-23T12:00:51.462Z",
      startDate: "2022-05-20T12:00:51.462Z" }]);
  ...
  ReactDOM.render( /*#__PURE__*/React.createElement(Calendar, null), document.getElementById("fcalcontainer"));

  const container = document.getElementById('fcalcontainer');
